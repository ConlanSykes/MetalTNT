 ...
 * 
 * Mixin classes cannot expose public static methods (Mixin framework rejects them).
...
public final class TextureCacheManager {
    ...
    // Incremented by RenderLayerMixin each time a draw targets an offscreen texture.
    ...
    public static final java.util.Map<Integer, Integer> offscreenDrawVersion =
